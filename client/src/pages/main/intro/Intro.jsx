		...
		<div className={style.intro}>
			<div className={style.intro_invite}>
				...
				<div className={style.intro_invite_text}>
					...
					>
						У нашего бота есть много уникальных и полезных функций, которые
						готовы помочь в модерировании и кастомизировании вашего сервера...
					</motion.p>
					<div className={style.intro_invite_text_buttons}>
						<a className={style.intro_to_discord} href={linkToInvite}>
							Пригласить в Discord
						</a>
						<Link className={style.a + ' ' + style.to_panel} to='/panel'>
							В панель управления
						</Link>
					</div>
				</div>
