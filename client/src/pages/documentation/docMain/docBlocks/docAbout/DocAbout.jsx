            ...
            <div className={style.container}>
                <div className={style.def}>
                    <div className={style.def_text} id='intro'>
                        <h3>О боте</h3>
                        <p><b>{botName}</b> — это Discord-бот, который предназначен для улучшения работы и взаимодействия участников на сервере. Он предоставляет широкий набор функций включающих в себя много полезных и интересных команд. Одна из особенностей бота — настройка прямо на сайте. Не мучейтесь с командами! </p>
                    </div>
                ...
                <div className={style.about_main}>
                    <div className={style.options} id='func'>
                        ...
                        <div className={style.option}>
                            ...
                            <p>Основные функции включают в себя настройку префикса, команды для получения информации о сервере, участниках, ролях и других элементах. Бот может также предоставлять полезные инструменты, такие как напоминания и голосования, чтобы упростить организацию работы на сервере и т.п.</p>
                        </div>
                        <div className={style.option}>
                            <b>Модерирование</b>
                        ...
                        <div className={style.option}>
                            ...
                            <p>Создайте уникальный стиль для вашего сервера прямо в панели управления ботом! Вы можете переименовывать каналы, менять логотип, названия, настраивать сообщения привествий и многое другое.</p>
                        </div>
                        <div className={style.option}>
                            <b>Рейтинг</b>
                            <p>Участвуйте в рейтинге серверов и занимайте топы. Лучшие сервера будут опубликованы здесь!</p>
                        </div>
                        <div className={style.option}>
                ...
                <div className={style.invite} id='invite'>
                    ...
                    <div className={style.invite_text}>
                        ...
                        <ol>
                            ...
                            <li>Следовать дальнейшним указаниям бота.</li>
                        </ol>
                        <b>Другой способ:</b>
                        <ol>
                ...
                <div className={style.configure} id='configure'>
                    ...
                    <div className={style.configure_text}>
                        ...
                        <ol>
                            ...
                            <li>Следовать дальнейшним указаниям бота.</li>
                            <li>После входа на главной странице нажмите на свою аватарку.</li>
                            <li>В открывшемся меню нажмите кнопку "Мои сервера".</li>
