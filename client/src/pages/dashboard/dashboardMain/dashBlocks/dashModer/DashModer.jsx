...
function DashModer({ serverData }) {
    ...
    // Функция, которая помогает readFields изменять поля
    // function readFieldsForCheckbox(value) {
    //     for (var key in listChangedSettings) {
    //         if (key === value) {
    //             return !listChangedSettings[key]
    //         }
    //     }
    //     return !serverData["settings"]["messagesMentionUser"]
    // }
            ...
            <div className={style.container}>
                ...
                <SettingsBlock title={"Основное"}>
                    <div className={style.sBlock_main}>
                        ...
                        <div className={style.sBlock_main_checkbox}>
                            <input type="checkbox" id="checkbox2" defaultChecked={serverData["settings"]["messagesMentionUser"]} onChange={() => {readFields("messagesMentionUser", document.getElementById("checkbox2").checked)}} />
                ...
                <SettingsBlock title={"Фильтрация сообщений"}>
                    <div className={style.sBlock_main}>
                        <div className={style.sBlock_main_checkbox}>
                            <input type="checkbox" id="checkbox1" defaultChecked={serverData["settings"]["messagesMentionUser"]} onChange={() => {readFields("messagesMentionUser", document.getElementById("checkbox1").checked)}} />
                            {/* <Checkbox defaultState={serverData["settings"]["messagesMentionUser"]} onClick={() => {readFields("messagesMentionUser", readFieldsForCheckbox("messagesMentionUser"))}} /> */}
