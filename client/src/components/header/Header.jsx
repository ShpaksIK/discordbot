...
import { botName, linkToInvite, linkToAuth, userData } from '../../modules/values'
...
function Header({ typeMenu }) {
    // Связь с backend. Получение данных и их сохранение
    // const getter = () => {
    ...
    const toggleIsLogin = () => setIsLogin((isLogin) => !isLogin)
